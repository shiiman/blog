...
slug: contact
status: publish
date: 2021-09-06T19:30:00.000Z
modified: 2021-09-08T01:34:48.000Z
...
![Contact Form 7](./assets/plugin_contact_form_7-1.png)

## フォーム作成

プラグインのインストールが完了して有効化が終わったら お問い合わせ -\> コンタクトフォーム から新規追加をしましょう。

![コンタクトフォーム](./assets/contact-form.png)
...
![コンタクトフォーム追加](./assets/contact_form2.jpg)
...
![コンタクトフォーム - 通知](./assets/contack_form3.jpg)
...
![コンタクトフォーム - 自動返信](./assets/contact_form4.png)

チェックをいれると先ほどと同じようなフォームが表示されます。

![](./assets/contact_form5.jpg)
...
![](./assets/contact_form6.jpg)

保存すると上の方にショートコードというものが表示されるので、こちらをコピーします。

![](./assets/contact_form7.png)
...
![コンタクトフォーム - ページ](./assets/contact_form8.png)

実際にどんな画面になったか見てみましょう。

こんな感じのお問い合わせフォームが出来上がったと思います。

![コンタクトフォーム - 送信](./assets/contact_form9.png)

...
draft: false
id: 637
modified: 2021-09-14T00:46:53.000Z
...
shiimanblog.com\
\
2021.09.01](/wordpress/backwpup/ "【Wordpress】おすすめのプラグイン Part 1 〜 BackWPup 〜")
...
![Updraft Plus - インストール](./assets/updraftplus.png)
...
![Updraft Plus - 設定1](./assets/updraftplus_setting1.jpg)
...
![Updraft Plus - 設定10](./assets/updraftplus_setting10.png)

中身を確認してみましょう。こちらがバックアップの中身になります。

![Updraft Plus - 設定11](./assets/updraftplus_setting11.png)
...
UpdraftPlusは復元も画面上から出来るのでとても簡単です。
...
![Updraft Plus - 設定2](./assets/updraftplus_setting2.jpg)

次に復元するコンポーネントを選択します。

分からない場合は全て選択すると、バックアップ時点の状態に全て戻ります。

![Updraft Plus - 設定3](./assets/updraftplus_setting3.png)

コンポーネントを選択して「次」を選択すると確認画面が表示されますので、問題なければ「復元」を押しましょう。するとバックアップファイルからWordPressの復元が行われます。

![Updraft Plus - 設定4](./assets/updraftplus_setting4.png)

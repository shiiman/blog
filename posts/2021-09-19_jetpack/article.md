...
![Jetpack - 登録1](./assets/Jetpack.png)

するとWordPressの設定画面に遷移しますので、まずはWordPress.comアカウントを作成します。

「Jetpackを設定」をクリックして遷移しましょう。

![Jetpack - 登録2](./assets/Jetpack_setting1.jpg)

Googleアカウントでの登録ができますので、使用するGoogleアカウントが選択されていたら「承認」しましょう。もし別のアカウントが選択されていたら「アカウントを切り替え」します。

![Jetpack - 登録3](./assets/Jetpack_setting2.png)

アカウント選択した後はプランの選択画面に遷移します。

最初は「Free」プランを選択しましょう。

![Jetpack - プラン選択](./assets/Jetpack.com_.png)

プラン選択の後はアンケート的なものが続きますので、どんどん次に進みましょう。

特に設定しなくても問題ないので「後で」を選択して問題ありません。

![Jetpack - 登録4](./assets/Jetpack_setting3.jpg)![Jetpack - 登録5](./assets/Jetpack_setting4.png)![Jetpack - 登録6](./assets/Jetpack_setting5.jpg)![Jetpack - 登録7](./assets/Jetpack_setting6.png)![Jetpack - 登録8](./assets/Jetpack_setting7.png)![Jetpack - 登録9](./assets/Jetpack_setting8.jpg)
...
こちらをONにするだけでサイトマップが更新されるたびに検索エンジンに自動で通知してくれます。

![Jetpack - 設定6](./assets/Jetpack_setting14.png)

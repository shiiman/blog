...
こちらは別の記事で導入方法を解説していおりますので、合わせて御覧ください。
 ...
 [![](./assets/eyecatch_google_search_console.png)\
\
...
![Google Analytics - 登録1](./assets/google_analytics0.png)

まずはアカウント名を設定します。

1つのアカウントで複数のwebサイトの登録が可能ですので、webサイトの名前とは別の名前を登録しましょう。

![Google Analytics - 登録2](./assets/google_analytics1-1.jpg)
...
![Google Analytics - 登録3](./assets/google_analytics2.png)
...
![Google Analytics - 登録4](./assets/google_analytics4.jpg)

作成後はデータストリームの作成を行います。

Choose a platform でウェブを選択し、その後ご自身のwebサイトのURLとストリーム名を登録しましょう。ストリーム名はご自身のwebサイトの名前で問題ありません。

![Google Analytics - 登録5](./assets/google_analytics5-1.jpg)![Google Analytics - 登録6](./assets/google_analytics6-1.jpg)
...
![Google Analytics - 登録7](./assets/google_analytics6.jpg)

クリックするとサイトごとに個別のトラッキングコードが表示されますのでこちらのタグをコピーしておきます。

![Google Analytics - 登録8](./assets/google_analytics8.png)
...
![Google Analytics - 登録9](./assets/google_analytics9-1.jpg)

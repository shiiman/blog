...
draft: false
id: 175
modified: 2021-09-24T21:51:30.000Z
...
上記の太字部分が異なる場合がなりすましと判定されてしまうパターンになります。
...
[ConoHa WING](https://px.a8.net/svt/ejp?a8mat=3HKUB1+DBVECY+50+5SI7RM) でWordPressを構築している場合はメールサーバも同時に用意してくれています。
...
![ConoHa Wing - メール設定1](./assets/conoha_mail1.png)
...
![ConoHa Wing - メール設定2](./assets/conoha_mail2.png)

すると新しいメールアドレスの取得が完了です。

![ConoHa Wing - メール設定3](./assets/conoha_mail3.png)
...
![ConoHa Wing - メール設定4](./assets/conoha_mail4-1.png)
...
これで [ConoHa WING](https://px.a8.net/svt/ejp?a8mat=3HKUB1+DBVECY+50+5SI7RM) 側のメール設定は完了です。

![ConoHa Wing - メール設定5](./assets/conoha_mail5-2.png)
...
![WP Mail SMTG by WPForms](./assets/wp_mail_smtp_by_wpforms.png)

### WP Mail SMTP by WPForms設定

プラグインの有効化ができたら設定を行っていきます。

![WP Mail Smtp by_ WPForms - 設定1](./assets/wp_mail_smtp_by_wpforms1-1.png)

SMTPメーラーを選択画面が表示されますので、「その他のSMTP」を選択します。

![WP Mail Smtp by_ WPForms - 設定2](./assets/wp_mail_smtp_by_wpforms2.png)
...
![WP Mail Smtp by_ WPForms - 設定3](./assets/wp_mail_smtp_by_wpforms3.jpg)
...
![WP Mail Smtp by_ WPForms - 設定4](./assets/conoha_mail6.png)

その後の設定はデフォルトで問題ありません。「保存して続行」をクリックします。

![WP Mail Smtp by_ WPForms - 設定5](./assets/wp_mail_smtp_by_wpforms4.jpg)

メール通知の設定が表示されますがこちらは登録する必要はありませんので、Skipを選択しましょう。

![WP Mail Smtp by_ WPForms - 設定6](./assets/wp_mail_smtp_by_wpforms5.png)

ライセンスの登録も求められますが、こちらもスキップで問題ありません。

![WP Mail Smtp by_ WPForms - 設定7](./assets/wp_mail_smtp_by_wpforms6.png)

以上で、プラグインの設定は終了です。

![WP Mail Smtp by_ WPForms - 設定8](./assets/wp_mail_smtp_by_wpforms7.png)
...
![Contact Form 7 - 送信元変更](./assets/mail_setting.png)

...
![slackbot -設定1](./assets/slackbot1.png)

するとポップアップが表示されます。

アプリの作成方法を選択できますので、こちらは「 **From scratch**」を選択します。

![slackbot -設定2](./assets/slackbot2.png)
...
![slackbot -設定3](./assets/slackbot3.png)
...
![slackbot -設定4](./assets/slackbot4.jpg)

---
title: >-
  【Snowflake】Macでsnowsqlを設定してみた | 「Failed to initialize log. No logging is
  enabled: [Errno 13] Permission denied」の対処方法
...
excerpt: >-
  MacでSnowflakeのCLIクライアント「SnowSQL」をインストール・設定する方法と、Permission
  deniedエラーの対処法を紹介します。

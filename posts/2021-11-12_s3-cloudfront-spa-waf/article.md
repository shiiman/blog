...
status: publish
date: 2021-11-12T19:30:00.000Z
modified: 2021-11-11T17:24:34.000Z
...
![s3+cloudfront構成図](./assets/1266bf9daf9ea60649edb5ff772bbeec.png)
...
![CloudFront - エラーページ1](./assets/error_page_setting1.png)

そしてレスポンスコード403, 404に対して200に変更しつつ「/index.html」を返すように設定します。

![CloudFront - エラーページ2](./assets/error_page_setting2.png)

![CloudFront - エラーページ3](./assets/error_page_setting3-1.png)

最終的に下記の画像のような設定ができていればOKです。

これでリロードした際はシングルページのindex.htmlにアクセスすることができ、エラーが表示されてしまう問題は解決できます。

![CloudFront - エラーページ4](./assets/error_page_setting4.png)
...
![WAF- 設定1](./assets/error_page_setting5.png)

レスポンスボディを設定し、名前をつけて保存します。

![WAF- 設定2](./assets/error_page_setting6.png)
...
![WAF- 設定3](./assets/error_page_setting7.png)
...
![WAF- 設定4](./assets/error_page_setting8.png)

保存が正常に完了すると下記のように表示されます。

![WAF- 設定5](./assets/error_page_setting9.png)

実際に許可していないIPでブラウザからアクセスした場合は下記のような表示がされることが確認できます。

![WAF- 設定6](./assets/error_page_setting10-1.png)

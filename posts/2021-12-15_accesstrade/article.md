...
使いづらい面としては商品の広告毎に申請 -\> 審査があるということです。

ここは少しハードルが上がる面になりますね。
...
上記から画面遷移すると下記のメールアドレス登録画面に移動します。
...
次はメールに記載のURLにアクセスし、会員情報を登録しましょう。
...
口座情報のラジオボタンにチェックを入れると金融機関の登録する項目が表示されます。

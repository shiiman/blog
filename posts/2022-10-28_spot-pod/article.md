...
クラウドの余剰リソースが少なくなってくると、Spot Podのコンテナには強制終了の25秒前にSIGTERMシグナルが発せられ、そしてシャットダウンが実行されます。
...
| 種別 | Pod | Spot Pod | Podに対するSpot Podの料金比率 |
| --- | --- | --- | --- |
| per vCPU per hour | $0.0571 | $0.0171 | 約30% |
| per GB per hour | $0.0063215 | $0.0018964 | 約30% |
